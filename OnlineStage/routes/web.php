...
Route::delete('/user/delete/{id}/{location}', [UsuarioController::class, 'destroyUser'])->middleware(['auth'])->name('user.destroy');
Route::get('/user/user_control', [UsuarioController::class, 'user_control'])->middleware(['auth'])->name('user.control');
/* TRAMOS */
...
Route::get('/searcht', [TramosController::class, 'search'])->name('tramos.search');//ruta publica
...
Route::get('/searchr', [RallysController::class, 'search'])->middleware(['auth'])->name('rallys.search');
...
Route::get('/searche', [EventosController::class, 'search'])->middleware(['auth'])->name('eventos.search');
