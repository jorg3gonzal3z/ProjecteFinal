    ...
    <div class="mt-3 card col-12 col-mb-12 col-lg-6 offset-lg-3 mb-2">
        ...
        <div class="card-body">
            ...
            @foreach ($users as $user)
                <div class="mt-2 rounded col-12 d-flex flex-wrap pt-3 " style="box-shadow:2px 2px 5px red;">
                    <div class="col-12 col-md-4 text-white ">{{$user->name}}</div>
                    <div class="col-12 col-md-4 text-white ">Rol :<span class="ml-2" style="color:red;"> {{$user->rol}}</span></div>
