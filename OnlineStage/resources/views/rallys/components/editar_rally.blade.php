                    ...
                    <form id="form_edit_rally:{{$rally->id}}" action="{{ route('rally.update',['id' => $rally->id,'location' => 'rallys'] ) }}" method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="col-12 d-flex flex-wrap">
                            ...
                            <div class="form-group form-group col-12 col-md-6 ">
                                ...
                                <input type="number" class="form-control" id="numTC" name="n-TC" value="{{$rally->numTC}}">
                            </div>

                            <div class="form-group form-group col-12 col-md-6 ">
                                <label class="text-white ">Numero de Assistencias</label>
                                <input type="number" class="form-control" id="numAssistencies" name="n-Assistencias" value="{{$rally->numAssistencies}}">
                            </div>

                            <div class="form-group form-group col-12 col-md-6 ">
                                <label class="text-white">Localizacion</label>
                                <input type="text" class="form-control" id="localitzacio" name="Localizacion" value="{{$rally->localitzacio}}">
                            </div>

                            <div class="form-group form-group col-12 col-md-6 ">
                                <label class="text-white">Numero de Plazas</label>
                                <input type="number" class="form-control" id="numPlaces" name="n-Plazas" value="{{$rally->numPlaces}}" disabled>
                            </div>
