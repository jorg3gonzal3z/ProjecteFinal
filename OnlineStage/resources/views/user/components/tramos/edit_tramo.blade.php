<!-- editar tramo -->
<a id="edit_tramo:{{$tramo->id}}" class="edit-tramo_btn btn btn-secondary float-right ml-3 text-white" data-toggle="modal" data-target="#modal{{$tramo->id}}" style="cursor:pointer;" ><i class="fa fa-pencil"></i> Editar</a>
<!-- eliminar tramo -->
